...
[!DNL Create] lie désormais les champs de texte et d’image associés dans les tailles et les pages dans un modèle multi-taille ou multi-page, de sorte qu’une modification du dernier kilomètre ne doit se produire qu’une seule fois. Sélectionnez l’étendue **[!UICONTROL Appliquer à]** dans le panneau de l’éditeur de texte enrichi (cette taille, toutes les tailles ou tous les concepts) et la modification se propage automatiquement, avec la possibilité d’ajuster manuellement le balisage des champs si nécessaire.
...
### Mise à jour de la disposition des cartes sur la page [!DNL Create] [!DNL Content]

Le point d’entrée [!DNL Create] à l’intérieur de [!DNL Content] présente une nouvelle disposition des cartes.

### Remplacement des fragments de contenu AEM dans les expériences e-mail sur la zone de travail HTML

Les [expériences e-mail](/help/user-guide/create/email-experiences.md) sur la zone de travail HTML permettent désormais de remplacer du contenu par des **fragments de contenu AEM** préapprouvés pour un contenu modulaire prédéfini. Plus besoin de coller du contenu provenant d’autres canaux.
...
Dans le [workflow de création](/help/user-guide/create/overview.md), **[!UICONTROL Sélectionner à partir du contenu]** s’ouvre désormais avec le tri **[!UICONTROL Pertinence]**, de sorte que la grille reflète les [!DNL Brands], les [!DNL Products], les [!DNL Personas] et les langues dans votre tiroir de prompts.

Ou si la récence doit être privilégiée par rapport à la pertinence contextuelle, passez à **[!UICONTROL Ajouté récemment]**.

### Publicités TV connectées (CTV) dans [!DNL Create]

**Adobe GenStudio pour CTV** permet aux responsables marketing de la performance de créer et de gérer des publicités CTV de haute qualité et conformes, grâce à un workflow optimisé basé sur l’IA générative, de la création au lancement.

Vous pouvez assembler des scènes, vous aider de l’IA générative lorsque des éléments audio ou visuels sont toujours manquants, affiner les scènes, puis exporter ou enregistrer dans [!DNL Content] après révision.
...
* plusieurs tailles par modèle ;
* des options de verrouillage et de déverrouillage de calque définies dans Express ;
* la modification WYSIWYG pour les éléments de modèle ;
* des commandes plus avancées pour la modification du texte, le remplacement de médias et du logo, le redimensionnement de la vidéo, etc.

Explorez les détails dans [Utiliser des modèles Adobe Express dans GenStudio for Performance Marketing](/help/user-guide/templates/express-templates.md).
...
Featurization V4 représente une mise à niveau complète de la version V3, introduisant une conception axée sur la publicité et de nombreuses nouvelles fonctionnalités spécifiques à la publicité pour les types de contenu image, texte et vidéo.

Les avantages de V4 sont les suivants :

* **Conception axée sur la publicité** : spécialement conçue pour l’analyse publicitaire, avec une suite complète d’analyses CTA/Offre/Logo (18 fonctionnalités combinées).
* **Taxonomie granulaire** : augmentation de 249 % du nombre total de fonctionnalités, avec une catégorisation claire et des définitions de fonctionnalités cohérentes pour les images, les textes et les vidéos.
...
* **Compréhension sémantique améliorée** : nouvelles fonctionnalités comprenant les personas de marque, les besoins humains, les déclencheurs cognitifs et la reconnaissance complète des entités.
* **Cohérence cross-canal** : fonctionnalités unifiées sur les différents types de contenu, permettant une analyse publicitaire cross-canal.
* **Optimisation mobile** : fonctionnalités dédiées au format, à l’ajustement du placement et à la détection native pour appareils mobiles.

**Principales nouveautés :**

* Suite Advertising (plus de 20 fonctionnalités) : analyse CTA/offre/logo, co-branding, détection d’influenceur ou d’influenceuse
...
* Mesures de la qualité vidéo (13 fonctionnalités) : qualité technique, classification de production, optimisation mobile.
* Reconnaissance d’entités (9 fonctionnalités) : influenceur ou influenceuse, événements, lieux, mentions de marque/produit, médias populaires.
...
* GenStudio for Performance Marketing s’intègre désormais à Adobe Real-Time Customer Data Platform (RTCDP), ce qui permet aux responsables marketing d’utiliser les définitions d’audience directement dans le workflow [!DNL Create].
* En sélectionnant les paramètres [!DNL Audience] lors de la génération de contenu, les responsables marketing peuvent créer des contenus créatifs et des textes d’e-mail personnalisés, en tenant compte du contexte client, notamment les préférences en matière de messages, les segments d’acheteurs et d’acheteuses, les étapes du parcours et les données comportementales.

### Innovid Insights pour la publicité display

* [!DNL Insights] inclut désormais Innovid (anciennement Flashtalking) comme canal de publicité display, ce qui permet aux responsables marketing d’analyser les performances des campagnes avec Meta, LinkedIn et TikTok dans une plateforme unifiée.
* Grâce à l’actualisation quotidienne des données et à l’accès aux mesures de performance clés, notamment les impressions, les clics et le taux de clics, les responsables marketing peuvent prendre des décisions d’optimisation plus rapides sans passer d’un outil à l’autre.
...
* Les responsables marketing peuvent désormais [exporter des contenus au format PDF](/help/user-guide/content/manage-assets.md#export-experiences) à des fins de révision, d’approbation et d’archivage.

### Modèles personnalisés sur Firefly Image Model 4

* GenStudio for Performance Marketing prend désormais en charge les [modèles personnalisés entraînés sur Adobe Firefly Image Model 4](/help/user-guide/create/generate-assets.md), offrant des fonctionnalités améliorées de génération d’images conformes à la marque, avec un photoréalisme et un niveau de détail renforcés.
...
* Analysez le [coût par action (CPA) avec un suivi de conversion flexible](/help/user-guide/insights/published-experiences.md) pour les campagnes publicitaires Meta.
* Au lieu d’une mesure fixe unique, sélectionnez parmi plusieurs types d’actions, tels que les achats, les événements d’ajout au panier, les leads, les vues de vidéos ou les conversions personnalisées, pour calculer et afficher le CPA des campagnes, des publicités, des ressources et des attributs dans [!DNL Insights].

### Correctifs et améliorations

* Une extension SDK a été ajoutée pour permettre aux clientes et clients de se connecter à leur propre système de gestion des ressources numériques au lieu d’utiliser AEM Assets par défaut pour les ressources lors de la génération de contenu.
* Les utilisateurs et utilisatrices peuvent désormais appliquer des balises [!DNL Brand] afin de regrouper les enregistrements [!DNL Product] et [!DNL Persona] par [!DNL Brand].
* Le flux [!DNL Experience Translations] a été optimisé, ainsi que la nouvelle fonctionnalité de traduction pour les expériences paid media et e-mail.
...
* Créez des publicités personnalisées et conformes à votre marque directement à l’aide des nouveaux plug-ins GenStudio pour les outils de conception Adobe Photoshop et Figma.

### Fonctionnalités vidéo améliorées

* Les responsables marketing peuvent désormais facilement ajouter des clips d’introduction et de conclusion pour encadrer les publicités vidéo avec un branding ou des messages préproduits.
* Ajoutez des superpositions d’images, de textes et de logos tout au long de la vidéo.
...
* GenStudio for Performance Marketing s’intègre désormais à Adobe Campaign V8, ce qui permet aux responsables marketing d’utiliser facilement la création de contenu optimisée par l’IA ainsi que les fonctionnalités d’orchestration avancées de Campaign.

### Lecture automatique de vidéo

* Les vidéos sont désormais automatiquement lues dans les modules [!DNL Create], [!DNL Content] et [!DNL Insights], offrant ainsi une expérience de prévisualisation fluide.
...
* La carte de prévisualisation de la publicité comprend désormais une option « Plus » pour le texte.
* Nouveaux modèles pour les cartes masonry de la page des publicités.
...
* Nouvelle fonctionnalité permettant d’enregistrer les brouillons des activations
* Nouvelle fonctionnalité permettant de relancer les activations ayant échoué
...
Adobe GenStudio for Performance Marketing prend désormais en charge la dernière suite Firefly Image Model 4, y compris deux variantes performantes :

**Firefly Image 4** : optimisé pour la vitesse et la simplicité, idéal pour générer des illustrations, des icônes, des photos d’objets de base et des portraits d’un seul sujet, couvrant 90 % des besoins créatifs quotidiens.

**Firefly Image 4 Ultra** : privilégie le photoréalisme et la précision, et excelle dans le rendu de portraits humains, de groupes de taille moyenne et de scènes complexes pour des tâches créatives haut de gamme.
...
Désormais, dans GenStudio for Performance Marketing [!DNL Create], vous pouvez utiliser les [fonctionnalités d’IA de développement génératif](/help/user-guide/create/manage-variants.md#use-generative-expand) pour étendre les dimensions des images et ajouter du contenu génératif afin d’adapter vos modèles de publicité aux différentes variantes de média acheté.
...
* Lors de l’ajout ou de la révision des [directives de marque](/help/user-guide/guidelines/brands.md) dans une langue autre que l’anglais, GenStudio for Performance Marketing affiche ces directives dans la même langue.
...
Le nouveau cadre d’extensibilité [GenStudio for Performance Marketing](/help/extensibility/setup.md) fournit aux entreprises des outils leur permettant d’intégrer leurs propres protocoles de conformité des allégations dans le processus de création et de validation de contenu, grâce à des modules complémentaires ou des applications extensibles.

### Modèles

* **Éditeur de code de modèle** : le nouvel [Éditeur de code de modèle](/help/user-guide/templates/code-editor.md) vous permet de vérifier et d’affiner votre modèle pour une utilisation optimale lors de la génération de nouvelles expériences dans GenStudio for Performance Marketing.
...
* Activation des fonctionnalités pour les directives de [canal par défaut](/help/user-guide/guidelines/brands.md#channel-guidelines), d’[image](/help/user-guide/guidelines/brands.md#image-guidelines), de [logo](/help/user-guide/guidelines/brands.md#logos) et de [couleur](/help/user-guide/guidelines/brands.md#colors) pour [[!DNL Brands]](/help/user-guide/guidelines/brands.md).
* Ajout de la possibilité d’[ajouter des liens à des images](/help/user-guide/create/manage-variants.md#add-image-link) dans une variante.
* Déplacement de la fonctionnalité [Vérification de contenu](/help/user-guide/guidelines/brand-validation.md) et Révision et approbation vers la nouvelle barre d’actions de droite afin d’optimiser l’espace sur la zone de travail et d’améliorer l’expérience d’utilisation.
* Simplification du flux de [chargement ou d’ajout manuel d’une marque](/help/user-guide/guidelines/add-guidelines.md#add-brands).
* Ajout de la possibilité d’[ajouter ou d’intervertir des ressources d’image dans une variante](/help/user-guide/create/manage-variants.md#swap-image) sur la zone de travail.
* Amélioration de l’expérience d’utilisation et de la visibilité des catégories de canaux [sur la page d’accueil Créer](/help/user-guide/create/overview.md) en les séparant en sections Média possédé, Média acheté et Contenu.
...
* Les tailles d’image personnalisées dans les modèles de publicité Meta sont désormais prises en charge. <!-- GS-7512 -->

* Les sélections de personas, de marques et de produits sont désormais préchargées lors de la génération du modèle. <!-- GS-8069 -->
...
* Le bouton **[!UICONTROL Précédent]** renvoie désormais à la page précédente ou à la page de destination [!DNL Create] comme prévu. <!-- GS-8622 -->
...
* Consultez les instructions spécifiques aux canaux dans la section [Bonnes pratiques relatives aux modèles](/help/user-guide/templates/best-practices-for-templates.md#follow-channel-specific-template-guidelines).
...
* Le tiroir de texte descriptif ne se ferme plus lorsqu’un éditeur ou une éditrice clique en dehors du menu déroulant du tiroir. <!-- GS-7275 -->

* Le menu déroulant [!DNL Create] [!DNL Persona]/[!DNL Product] se charge désormais comme prévu lorsqu’une erreur de service d’URL de vignette se produit. <!-- GS-7277 -->

* Les publicités display qui contiennent des éléments qui recouvrent des fragments sont désormais modifiables. <!-- GS-7186 -->

* Le bouton de zone de travail de la **[!UICONTROL Marque]** est désormais désactivé lorsque les scores de la marque ne sont pas générés pour une expérience. <!-- GS-6429 -->
...
* Les champs de modèle inutilisés ne sont plus affichés dans le contenu généré. <!-- GS-5670 -->

* Les éditeurs et éditrices peuvent désormais cliquer une seule fois sur les liens pour les modifier comme prévu dans les variantes générées. <!-- GS-7423 -->

* [!DNL Create] respecte désormais correctement les privilèges des collaborateurs et collaboratrices. <!-- GS-7614 -->

* Le bouton **[!UICONTROL Redimensionner]** la zone de travail est désormais désactivé une fois que toutes les options de redimensionnement ont été sélectionnées et appliquées. <!-- GS-5940 -->
...
* La zone de travail affiche désormais les publicités Meta redimensionnées et les publicités display dans le bon ordre. <!-- GS-7375 -->

* Les éditeurs et éditrices peuvent désormais cliquer simultanément dans les champs des e-mails et des publicités display. <!-- GS-6297 -->
...
* Tous les caractères sont désormais correctement représentés dans le HTML exporté. <!-- GS-7246 -->
...
Cette version comprend des améliorations de la localisation dans toute l’interface d’utilisation, notamment :
...
* Toutes les info-bulles de la vue [!DNL Content] _Ressources_ et du champ **[!UICONTROL Recherche]** sont localisées. <!-- GS-6879 -->
* Lors du remplacement d’une image existante dans une variante d’e-mail sur la zone de travail [!DNL Create], la vue _Sélectionner dans le contenu_ est désormais localisée. <!-- GS-6906 -->
...
* L’icône _Enregistrement en cours_ ne s’affiche plus lors du clic sur **[!UICONTROL Charger une nouvelle image]**, puis de l’annulation de l’opération avant la fin du chargement. <!-- GS-6780 -->

* Les titres des expériences sont désormais créés correctement lors de la nouvelle génération des expériences. <!-- GS-7006 -->
...
* La suppression d’une image du tiroir de texte descriptif lors d’une opération de redimensionnement n’entraîne plus d’erreur. <!-- GS-7115 7009 -->

* La sélection de **[!UICONTROL Supprimer]** dans le menu d’actions [!DNL Create] (…) fonctionne désormais comme prévu. <!-- GS-6871 -->
...
* Le tiroir de prompt [!DNL Create] se ferme désormais comme prévu lorsqu’une personne clique ailleurs. <!-- GS-5254 -->

* L’export des publicités Meta inclut désormais le libellé d’appel à l’action sélectionné, comme prévu. <!-- GS-6504 -->

* Le score de la marque est maintenant mis à jour et conservé comme prévu pour les expériences générées à nouveau. <!-- GS-6535 -->

* L’export HTML des publicités Meta et display n’inclut plus les éléments `div` et `chrome`. <!-- GS-7116 -->

* Les problèmes de rendu des brouillons d’e-mails lors de la publication sont désormais résolus. <!-- GS-6394 -->

* Le bouton de zone de travail de la **[!UICONTROL Marque]** est désormais désactivé lorsqu’un score de marque n’est pas généré. <!-- GS-6429 -->

* Le bouton (bascule) Facebook/Instagram de la barre d’actions de la zone de travail met désormais à jour les rendus d’expérience comme prévu lorsque le paramètre de la zone de travail `ReadOnly` est activé. <!-- GS-7039 -->
...
* Des libellés de lecteur d’écran manquants ont été ajoutés aux éléments `view` mobile et de bureau. <!-- GS-5624 4729 -->

* Les zones de ligne d’objet et de pré-en-tête des e-mails de zone de travail **[!DNL Create]** ont désormais une hauteur dynamique. <!-- GS-6258 -->
...
GenStudio for Performance Marketing s’intègre à d’autres produits Adobe CX Enterprise, notamment Adobe Express et Adobe AEM Assets.
