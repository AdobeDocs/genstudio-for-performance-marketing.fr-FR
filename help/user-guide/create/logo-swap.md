---
title: Utiliser la permutation de logo dans  [!DNL Create]
description: Apprenez à permuter les logos de marque dans les modèles pendant le  [!DNL Create] .
...
1. Vous pouvez également utiliser des logos de recherche par nom de marque ou par filtre pour trouver un logo.
   ![Rechercher des logos par marque](./logo-name-search.png){width="300"}
1. Vous pouvez également utiliser une recherche par filtre pour trouver un logo.
   ![Filtrer les logos](./logo-filter-search.png){width="300"}
