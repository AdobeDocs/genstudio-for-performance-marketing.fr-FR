...
Configurez une connexion entre GenStudio for Performance Marketing et les comptes sociaux de votre organisation pour recevoir des données de vos campagnes marketing, ressources et expériences actives. [!DNL Insights] fournit des outils pour analyser les données dérivées du canal. Voir [Connexion aux métadonnées publicitaires](/help/user-guide/connectors/meta-ads.md).
