---
title: Présentation des directives relatives aux canaux
description: Ajoutez des instructions de canal à GenStudio for Performance Marketing pour créer un profil de marque complet qui inclut tous les aspects de la représentation d’une marque.
level: Beginner
...
Les directives de GenStudio for Performance Marketing peuvent être chargées ou ajoutées manuellement dans GenStudio for Performance Marketing, ce qui permet aux utilisateurs d’établir des directives de marque qui capturent l’essence de l’identité d’une marque.
...
* Instructions définies par l’utilisateur (telles que [!DNL Brands], [!DNL Products] et [!DNL Personas])
* Recommandations relatives à Platform pour les canaux tels que Meta, LinkedIn, etc
...
Voir [Ajouter des directives](/help/user-guide/guidelines/add-guidelines.md) pour savoir comment ajouter chaque type.
...
Les instructions de canal permettent de disposer de deux cas d’utilisation principaux pour s’assurer que tout contenu généré respecte la représentation souhaitée d’une marque :
...
Outre les fonctionnalités d’IA générative d’Adobe, [!DNL Brands], [!DNL Products] et [!DNL Personas] jouent un rôle essentiel pour vous assurer que tout votre contenu GenStudio for Performance Marketing s’aligne sur l’identité de votre marque.
...
* **Conformité de la plateforme** : essentiel pour respecter les directives spécifiques de chaque plateforme, telles que Meta ou LinkedIn, ainsi que les bonnes pratiques du secteur. Il s’agit des instructions par défaut présentes dans le système et pré-renseignées dans [[!DNL Brand] instructions](/help/user-guide/guidelines/brands.md#brands-guidelines).
