...
Le tableau suivant présente chaque catégorie d’instructions relatives aux images et les valeurs associées. Vous devez [établir une catégorie](add-guidelines.md#add-brands) telle que « Directives générales sur l’art » ou « Photographie de produit » pour appliquer les directives sur les images.
