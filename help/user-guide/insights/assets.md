...
| **[!UICONTROL Taux de clics ]**<br>_CTR_ | Pourcentage (%) d’impressions qui ont généré des clics sur les ressources dans une expérience.<br>**Calcul** : `clicks` divisé par `impressions` | Un taux de clic publicitaire élevé indique que le contenu est très pertinent et motivant pour le public dans la messagerie et la conception, et qu’il cible efficacement les intérêts du public. |
