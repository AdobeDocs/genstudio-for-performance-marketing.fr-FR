...
| Distance du sujet | Distance entre la caméra et le sujet d’une image. | `close up`, `mid shot`, `long shot`<p>Exemple de `closeup shot` :<p>![gros plan](/help/assets/category/image-subject-distance.png "Gros plan sur fleur et abeille perlée"){width="200" zoomable="yes"} |
