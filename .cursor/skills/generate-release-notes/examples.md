...
À utiliser uniquement lors de la **création** d’une nouvelle page de notes de mise à jour à partir de zéro. Si le fichier existe déjà, conservez plutôt son front-office complet.
...
## Section Fonctionnalités (avec Beta)
...
## Section Feature (lien vers la documentation en prose)
...
## Correctifs et améliorations (puces)
...
N&#39;utilisez cette sous-section que pour les articles **explicitement** étiquetés comme correctifs ou améliorations dans le matériau de base.

## Bloc archivé (notes de mise à jour antérieures)
